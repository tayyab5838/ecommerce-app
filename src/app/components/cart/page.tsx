  ...
  return (
    <div className="mx-16">
      ...
      <div className="mt-16 mx-8">
        <h2 className="font-soraFont font-semibold text-sm ">Shopping Cart</h2>
        {/* main div */}
        {items.length > 0 ? (
          <div className="flex justify-between mt-3">
            ...
            <div className="flex justify-between w-full h-fit">
              ...
              {/* left side */}
              <div className="flex flex-col w-3/4 justify-between gap-y-2 mb-4">
                {items.map((item: any, id: any) => {
                  return (
                    <div className="flex" key={id}>
                      ...
                      <div className="flex flex-col w-3/4 justify-between gap-y-2 mb-4 ml-4">
            ...
            {/* Order Summary */}
            <div className="flex flex-col bg-[#fbfcff] p-6 h-fit gap-y-4 ml-4">
          ...
          <div className="flex justify-center items-center mt-8">
            <h2 className="font-soraFont font-bold text-lg">
